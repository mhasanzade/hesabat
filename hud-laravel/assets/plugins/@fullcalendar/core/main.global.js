    ...
    */
    ...
    function buildTitleFormat(dateProfile) {
        ...
        if (currentRangeUnit === 'month') {
            return { year: 'numeric', month: 'long' }; // like "Sentyabr 2014"
        }
        ...
        // one day. longer, like "Sentyabr 9 2014"
    ...
    */
    ...
    var TableDowCell = /** @class */ (function (_super) {
        ...
        TableDowCell.prototype.render = function () {
            ...
            var date = addDays(new Date(259200000), props.dow); // start with Sun, 04 Yanvar 1970 00:00:00 GMT
            var dateMeta = {
                dow: props.dow,
                isDisabled: false,
                isFuture: false,
