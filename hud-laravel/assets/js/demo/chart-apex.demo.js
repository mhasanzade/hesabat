...
var handleRenderApexChart = function() {
	...
	var apexLineChartOptions = {
		...
		xaxis: {
			categories: ["Yanvar", "Fevral", "Mart", "Aprel", "May", "İyun", "İyul"],
		},
		yaxis: {
			min: 5,
			max: 40
	...
	var apexColumnChartOptions = {
		...
		xaxis: {
			categories: ["Fevral", "Mart", "Aprel", "May", "İyun", "İyul", "Avqust", "Sentyabr", "Oktyabr"],
		},
		yaxis: {
			title: {
				text: '$ (thousands)',
	...
	var apexBubbleChartOptions = {
		...
		series: [{
				name: 'Bubble1',
				data: generateBubbleChartData(new Date('11 Fevral 2017 GMT').getTime(), 20, {
					min: 10,
					max: 60
				})
			},
