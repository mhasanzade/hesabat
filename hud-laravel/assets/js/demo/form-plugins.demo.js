...
var handleRenderSelectPicker = function() {
	...
	$('#ex-multiselect').picker({ search: true });
	$('#ex-search').picker({ search: true });
	$('.ex-search').picker('disable');
	$('#ex-multiselect-limit').picker({limit: 1, search:true});
	$('#ex-multiselect-limit-2').picker({limit: 1, search:true});
